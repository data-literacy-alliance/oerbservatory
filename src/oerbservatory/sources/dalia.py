...
# description = "Functionality in the OERbservatory Python package that converts from the external DALIA Interchange Format (DIF) to the OERbservatory's internal data model."
